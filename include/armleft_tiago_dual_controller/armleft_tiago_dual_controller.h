...
*/
class MyEnergyShapingPositionController : public controller_interface::ControllerBase
{
public:
...
PLUGINLIB_EXPORT_CLASS(armleft_tiago_dual_controller::MyEnergyShapingPositionController, controller_interface::ControllerBase)
